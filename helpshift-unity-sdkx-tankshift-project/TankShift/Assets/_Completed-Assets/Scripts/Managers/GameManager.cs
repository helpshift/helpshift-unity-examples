...
namespace Complete
{
    public class GameManager : MonoBehaviour
    {
        ...
        public GameObject m_ContactUsButton;
        ...
        public void PlayGame() {
            if(m_PlayButton.GetComponentInChildren<Text>().text == "NEW GAME") {
                SpawnAllTanks();
                SetCameraTargets();
            ...
            m_ContactUsButton.SetActive(false);
            m_PauseButton.SetActive(true);
        }

        public void PauseGame() {
            if(!OneTankLeft()) {
                m_PlayButton.GetComponentInChildren<Text>().text = "RESUME";
            } else {
                m_PlayButton.GetComponentInChildren<Text>().text = "NEW GAME";
            }

            m_PlayButton.SetActive(true);
            m_HelpButton.SetActive(true);
            m_ContactUsButton.SetActive(true);
            m_PauseButton.SetActive(false);
            DisableTankControl ();
        }

        public void HelpSupport() {
            _support.ShowFAQs(GetConversationConfig());
        }

        public void ContactUsSupport() {
            _support.ShowConversation(GetConversationConfig());
        }
        ...
        private string EndMessage()
        {
            ...
            if (m_GameWinner != null)
                message = m_GameWinner.m_ColoredPlayerText + " WINS!";
